package com.storyhasyou.example.boot.resultmapper;
...
public class HighlightResultMapper extends AbstractResultMapper {
    ...
    public HighlightResultMapper(String... highlightFields) {
    ...
    private <T> void setHighlight(T result, SearchHit hit, Class<T> clazz) {
        try {
            Map<String, HighlightField> highlightFields = hit.getHighlightFields();
            for (String highlightField : this.highlightFields) {
                ...
                if (highlight != null) {
                    ...
                    if (ArrayUtils.isNotEmpty(fragments)) {
                        ...
                        Field originalField = clazz.getDeclaredField(highlightField);
                        originalField.setAccessible(true);
                        originalField.set(result, fragment);
                    }
                }
            }
